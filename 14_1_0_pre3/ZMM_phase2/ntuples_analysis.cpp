...
int main()
{
    ...
    std::string FILE_PATH{"new2_phase2_ZMM_PU.root"};
    std::string RESULTS_FOLDER{"new2_ntuples_plots/"};
    ...
    TTreeReaderArray<Double_t> l2_seed_eta{reader, "phase2_l2_seed_eta"};
