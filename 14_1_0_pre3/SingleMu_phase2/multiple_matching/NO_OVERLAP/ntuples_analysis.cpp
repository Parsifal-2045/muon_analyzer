...
int main()
{
    ...
    std::string FILE_PATH{"phase2_multiple_matching_SingleMu_1k_NO_OVERLAP.root"};
    ...
    histos_2d["phase2_l2_seed_pt_vs_eta"] = new TH2F("phase2_l2_seed_pt_vs_eta", "Phase2 L2 seeds pT vs #eta", 100, -2.5, 2.5, 50, 50, 150);
