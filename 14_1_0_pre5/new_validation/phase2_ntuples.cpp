...
int main()
{
    ...
    std::string FILE_PATH{"data/IO_first_new_validation_ZMM_5k.root"};
    std::string RESULTS_FOLDER{"phase2_ntuples_plots/"};
    ...
    if (FILE_PATH.find("IO") != std::string::npos)
    {
        names.push_back("l2_mu_to_reuse");
    }
    if (FILE_PATH.find("OI") != std::string::npos)
    {
